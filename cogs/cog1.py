...
class cog1(commands.Cog):
    ...
    @slash_command(
        guild_ids=[714354863349170187, 511924606651727895], name="ping", description="check the latency of the bot!"
    )
    async def ping(self, ctx):
        ...
        """
        return await ctx.respond(f"{round(self.bot.latency * 1000)}ms")
